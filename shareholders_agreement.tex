...
\fancyhead[R]{\small Effective Date: 9 June 2025}
...
\input{sections/2_recitals.tex} % Formerly 2_background.tex
\input{sections/3_interpretation.tex}
\input{sections/4_shareholdings_vesting.tex}
\input{sections/5_intellectual_property.tex} % IP and Confidentiality provisions
\input{sections/5_leaver_provisions.tex} % Formerly Leaver_Provisions.tex
\input{sections/6_share_transfer.tex} % Enhanced version of original 5_share_transfer.tex
\input{sections/6_exit_mechanisms.tex} % This was named Exit Strategies & Deadlock Resolution in our discussions
\input{sections/7_management.tex} % Enhanced Management & Corporate Governance
\input{sections/9_financial_matters.tex} % Enhanced Financial Provisions 
\input{sections/11_general_clauses.tex} % New General Clauses section
\input{sections/11_execution.tex} % Updated Execution section (was 12_execution.tex)

% --- Schedules ---
\newpage % Start schedules on a new page
\input{sections/10_schedules.tex} % This master file inputs Schedule_1, Schedule_2, Schedule_3, Schedule_4_KPIs
